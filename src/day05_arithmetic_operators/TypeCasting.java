...
public class TypeCasting {
    public static void main(String[] args) {
        ...
        byte b = 14;
        int i = (int)b; // int is bigger than byte, so this is okay

        long l = 40; // by default 40 is int type, int can automatically be stored into a long because int is smaller than long
        long l2 = 3000000000l; // 3000000000 is int by default, but it is too big for int type, so we need to tell the compiler it
                               // is a long type with the L
        ...
        int i3 = 500;
        byte b2 = (byte)i3; // int is bigger than byte, so we need to cast
