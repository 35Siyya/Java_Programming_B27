...
public class DynamicIndexOf {
    public static void main(String[] args) {
        ...
        System.out.println("Last i: " + str.indexOf('i'));
        ...
        int secondI = str.indexOf('i', firstI + 1);// take previos index and add 1 to it so we can start looking for the next occurrence
