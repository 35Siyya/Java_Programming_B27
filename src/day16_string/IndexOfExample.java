...
public class IndexOfExample {
    public static void main(String[] args) {
        ...
        System.out.println("index of pop: " + s.indexOf("pop"));// gives 5 because the sequence "pop" stars at index 5
        System.out.println("index of Pop: " + s.indexOf("Pop"));//does not exist because there is no upper case p in our index its gonna give us -1
