...
public class Library {
    ...
    public static void main(String[] args) {
        ...
        book2.duration = 54.20;
        book2.narrator = "James Renan";
        book2.hasMovie = true;
        //book2 has access to 8 variables.All the variables from the parents Book class and the 2 variables declared in the AudioBook class
