...
list3: {1, 2, 3, 4, 5, 6}
    ...
    public static void main(String[] args) {
        ...
        letters.removeIf(p -> !Character.isLetter(p.charAt(0)));//p is every element, every element each character
       // of the String, but those characters type, so in order to get a char type we did charAt(0).Character methods needed to be a char type.....
