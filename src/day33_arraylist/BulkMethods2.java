...
public class BulkMethods2 {
    public static void main(String[] args) {
        ...
        ArrayList<Integer> nums = new ArrayList<>(Arrays.asList(4,1,1,2,3,4,5,1,4,4,14,5,123));
        System.out.println("contains 4 " + nums.contains(4));
        System.out.println("contains 4 & 5 " + (nums.contains(4) && nums.contains(5)));
        System.out.println("checking with containsAll " + nums.contains(Arrays.asList(4,3,5,1)));
        System.out.println("checking with containsAll " + nums.contains(Arrays.asList(4,3,5,6)));
