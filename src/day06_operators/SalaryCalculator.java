...
public class SalaryCalculator {
    public static void main(String[] args) {
        /*
          create a class SalaryCalculator add a main method declare and assign these variables:
      ...
      Print the tax rates, your total salary, the amount of tax for state and federal, the total tax amount, and your salary after all taxes
        ...
        String taxReport = "|  Salary " + salary + " | State tax rate: " + stateTaxRate + " | Federal tax rate: "
        + federalTaxRate + "\nStatetax:  $" + stateTax + " | Federal tax: $" + federalTax + "Total tax: $ "
