...
public class School {
        /*  Add a new class School
         add main method declare and assign all these variables: (all int) grade1, grade2, grade3, grade4, grade5
        ...
        */
        public static void main(String[] args) {
            ...
            double averageGpa = 3.8, numberOfSchoolDays = 110.5, numberOfTheSnowDays = 3.5;

            System.out.println(total);
            System.out.println(averageGpa);
            System.out.println(numberOfSchoolDays);
            System.out.println(numberOfTheSnowDays);
